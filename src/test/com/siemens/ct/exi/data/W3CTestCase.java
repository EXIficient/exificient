...
public class W3CTestCase extends AbstractTestCase
{
	...
	protected void setUp ()
	{
		...
		testCaseOptions.lastElement ( ).setXmlEqual ( false );
		 ...
		 // #4
		 testCaseOptions.add ( new TestCaseOption() );
		 testCaseOptions.lastElement ( ).setCodingMode (
	...
	public static void setConfigurationW3CXMLSample ()
	{
		...
		QuickTestConfiguration.setXmlLocation ( "./data/W3C/XMLSample/XMLSample.xml" );
		QuickTestConfiguration.setExiLocation ( "./out/W3C/XMLSample/XMLSample.exi" );
	}
	...
	{
		QuickTestConfiguration.setXsdLocation ( "./data/W3C/XMLSample/XMLSample.xsd" );
		QuickTestConfiguration.setXmlLocation ( "./data/W3C/XMLSample/XMLSample_pfx.xml" );
		QuickTestConfiguration.setExiLocation ( "./out/W3C/XMLSample/XMLSample_pfx.exi" );
	}
	...
	public static void setConfigurationW3CEXIbyExample ()
	{
		...
		QuickTestConfiguration.setXmlLocation ( "./data/W3C/EXIbyExample/XMLSample.xml" );
		QuickTestConfiguration.setExiLocation ( "./out/W3C/EXIbyExample/XMLSample.exi" );
	}
	...
	public static void setConfigurationW3CPrimerNotebook ()
	{
		...
		QuickTestConfiguration.setXmlLocation ( "./data/W3C/PrimerNotebook/notebook.xml" );
		QuickTestConfiguration.setExiLocation ( "./out/W3C/PrimerNotebook/notebook.exi" );
	}
