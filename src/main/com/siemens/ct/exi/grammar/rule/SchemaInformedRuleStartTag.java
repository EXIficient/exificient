				...
				else
				{
					...
					else
					{
						...
						else
						{
							...
							{
								// NS & SC
								addToEC2 += fidelityOptions.isFidelityEnabled ( FidelityOptions.FEATURE_PREFIX ) ? 1
										: 0;
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						boolean fNS = fidelityOptions.isFidelityEnabled ( FidelityOptions.FEATURE_PREFIX );
						boolean fSC = fidelityOptions.isFidelityEnabled ( FidelityOptions.FEATURE_SC );
						...
						// SC (without NS)
						else if ( isFirstElementRule && fSC && !fNS && eventCode == 0 )
						{
							eventType = EventType.SELF_CONTAINED;
						}
						else
