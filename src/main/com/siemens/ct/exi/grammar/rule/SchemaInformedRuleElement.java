 ...
 * Element i, j :
 * SE (*) Element i, j	n.m
 * CH [schema-invalid value ] Element i, j	n.(m+1)
...
public class SchemaInformedRuleElement extends AbstractSchemaInformedRuleContent
{
	...
	public int get2ndLevelEventCode ( EventType eventType, FidelityOptions fidelityOptions )
	{
		...
		if ( contains ( END_ELEMENT_EVENT ) )
		{
			ec = getEventCode( eventType, get2ndLevelElementItems ( fidelityOptions ) );
		}
		else
		{
			...
			{
				ec = 1 + getEventCode( eventType, get2ndLevelElementItems ( fidelityOptions ) );
			}
	...
	public EventType get2ndLevelEvent ( int eventCode, FidelityOptions fidelityOptions )
	{
		...
		else
		{
			...
			{
				return get2ndLevelElementItems ( fidelityOptions ).get( eventCode - 1 );
			}
		}
	}
