...
public class XSDDatetime
{
	...
	public void parseEXIDatetime ( String cal, DatetimeType type ) throws XMLParsingException
	{
		this.type = type;
	...
	{
		return cal.getTimeZone ( ).getRawOffset ( ) / ( 1000 * 60 ) + TIMEZONE_OFFSET_IN_MINUTES;
	}
