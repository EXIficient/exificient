		...
		if ( JRE6_OR_GREATER ) {
			...
			while (exiReader.hasNext()) { 
			    ...
			    case XMLStreamConstants.START_ELEMENT:
			    	...
			    	xmlw.writeStartElement(pfx, qn.getLocalPart(), qn.getNamespaceURI());
			    	...
			    	for(int i=0; i<atCnt; i++) {
			    		...
			    		xmlw.writeAttribute(atPfx, atQn.getNamespaceURI(), atQn.getLocalPart(), atVal);
			    	}
			    ...
			    case XMLStreamConstants.PROCESSING_INSTRUCTION:
			    	xmlw.writeProcessingInstruction(exiReader.getPITarget(), exiReader.getPIData());
			    	break;
