...
public class TestSAXDecoder extends AbstractTestDecoder {
	...
	public TestSAXDecoder(EXIFactory ef) throws EXIException, TransformerConfigurationException {
		super();
...
//	@Override
//	public void setupEXIReader(EXIFactory ef) throws EXIException, TransformerConfigurationException {
//		exiReader = ef.createEXIReader();
//		
//		transformer = tf.newTransformer();
//		
...
//	}
	...
	public static void main(String[] args) throws Exception {
		// create test-decoder
		TestSAXDecoder testDecoder = new TestSAXDecoder(TestSAXDecoder.getQuickTestEXIactory());
